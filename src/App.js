  ...
  handleClick = e => {
    ...
    if (input_cid === customers_id_list[input_cid - 1]) {
      this.setState({
        ...
        April: calculate_rewards(
          customer_data.filter(
            customer => customer.cid === input_cid && customer.month === "April"
          )
        ),
        May: calculate_rewards(
          customer_data.filter(
            customer => customer.cid === input_cid && customer.month === "May"
          )
        ),
        June: calculate_rewards(
          customer_data.filter(
            customer => customer.cid === input_cid && customer.month === "June"
          )
        ),
        Total: calculate_rewards(
          customer_data.filter(customer => customer.cid === input_cid)
        )
      });
    } else {
...
const customer_data = [
  ...
  { cid: 1, cname: "Ashik", month: "May", bill: 1, amount: 125 },
  { cid: 2, cname: "Dinesh", month: "May", bill: 1, amount: 155 },
  { cid: 3, cname: "Rahul", month: "May", bill: 1, amount: 185 },
  { cid: 4, cname: "Eric", month: "May", bill: 1, amount: 205 },
  { cid: 1, cname: "Ashik", month: "May", bill: 2, amount: 225 },
  { cid: 2, cname: "Dinesh", month: "May", bill: 2, amount: 255 },
  { cid: 3, cname: "Rahul", month: "May", bill: 2, amount: 285 },
  { cid: 4, cname: "Eric", month: "May", bill: 2, amount: 305 },
  { cid: 1, cname: "Ashik", month: "May", bill: 3, amount: 325 },
  { cid: 2, cname: "Dinesh", month: "May", bill: 3, amount: 355 },
  { cid: 1, cname: "Ashik", month: "June", bill: 1, amount: 130 },
  { cid: 2, cname: "Dinesh", month: "June", bill: 1, amount: 160 },
  { cid: 3, cname: "Rahul", month: "June", bill: 1, amount: 190 },
  { cid: 4, cname: "Eric", month: "June", bill: 1, amount: 210 },
  { cid: 1, cname: "Ashik", month: "June", bill: 2, amount: 230 },
  { cid: 2, cname: "Dinesh", month: "June", bill: 2, amount: 260 },
  { cid: 3, cname: "Rahul", month: "June", bill: 2, amount: 290 },
  { cid: 4, cname: "Eric", month: "June", bill: 2, amount: 310 },
  { cid: 1, cname: "Ashik", month: "June", bill: 3, amount: 330 },
  { cid: 2, cname: "Dinesh", month: "June", bill: 3, amount: 360 }
];
